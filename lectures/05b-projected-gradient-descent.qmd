...
A [Jupyter notebook](https://colab.research.google.com/github/ZhuoranYang/sds632-notes/blob/main/notebooks/projected-gradient-frank-wolfe.ipynb) accompanies this chapter with runnable Python implementations of projected gradient descent and the Frank--Wolfe (conditional gradient) method on constrained problems.
:::
