...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ZhuoranYang/sds632-notes/blob/main/notebooks/projected-gradient-frank-wolfe.ipynb) A companion notebook accompanies this chapter with runnable Python implementations of projected gradient descent and the Frank--Wolfe (conditional gradient) method on constrained problems.
:::
