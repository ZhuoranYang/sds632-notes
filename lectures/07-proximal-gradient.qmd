...
A [Jupyter notebook](../notebooks/subgradient-proximal-gradient.ipynb) accompanies this chapter with runnable Python implementations of proximal gradient (ISTA/FISTA) implementations, soft-thresholding for Lasso, and convergence comparisons with subgradient methods.
:::
