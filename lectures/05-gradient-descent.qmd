...
A [Jupyter notebook](../notebooks/gradient-descent.ipynb) accompanies this chapter with runnable Python implementations of gradient descent convergence experiments, Polyak--Łojasiewicz functions, and comparisons of step size strategies.
:::
