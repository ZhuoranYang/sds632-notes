...
A [Jupyter notebook](../notebooks/accelerated-gradient.ipynb) accompanies this chapter with runnable Python implementations of Nesterov's accelerated gradient, FISTA for Lasso, momentum trajectory visualization, condition number dependence experiments, and adaptive restart strategies.
:::
