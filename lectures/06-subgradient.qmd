...
A [Jupyter notebook](../notebooks/subgradient-proximal-gradient.ipynb) accompanies this chapter with runnable Python implementations of subgradient methods and proximal gradient descent, including ISTA for Lasso and convergence comparisons.
:::
