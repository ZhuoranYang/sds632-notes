...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ZhuoranYang/sds632-notes/blob/main/notebooks/newton-method.ipynb) A companion notebook accompanies this chapter with runnable Python implementations of all the key examples: Newton's method for minimization, Newton--Raphson behaviors, Newton fractals, damped Newton with line search, and convergence experiments.
:::
