...
A [Jupyter notebook](../notebooks/mirror-descent.ipynb) accompanies this chapter with runnable Python implementations of Bregman divergence visualization, mirror descent on the simplex with multiplicative weights, dimension-free rate comparisons, and the online experts problem.
:::
